      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="text-center sm:text-left">
            <div className="text-lg font-bold text-gray-900">Xi<span className="text-[#8b5cf6]"> Chen</span></div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-50 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-[9px] text-gray-300 font-mono">&copy; {new Date().getFullYear()} Chen Xi</p>
          <p className="text-[9px] text-gray-300 font-mono flex items-center gap-1">Made with <FiHeart size={9} className="text-red-400" /> by Chen Xi</p>
        </div>
      </div>
    </footer>
  );
