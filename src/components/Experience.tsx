      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-5xl mx-auto mb-20">
          <motion.div className="flex items-center gap-3 mb-8" initial={{ opacity: 0, x: -12 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            ...
            <div><span className="tag-framer text-[10px]">{tt("experience.internship")}</span><h3 className="text-xl font-bold text-gray-900 mt-1">{tt("experience.internshipTitle")}</h3></div>
          </motion.div>
          {internship.map((e, i) => (
        ...
        <div className="max-w-5xl mx-auto">
          <motion.div className="flex items-center gap-3 mb-8" initial={{ opacity: 0, x: -12 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            ...
            <div><span className="tag-framer tag-framer-muted text-[10px]">{tt("experience.campus")}</span><h3 className="text-xl font-bold text-gray-900 mt-1">{tt("experience.campusTitle")}</h3></div>
          </motion.div>
