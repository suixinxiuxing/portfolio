      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-10">
          <motion.div initial={{ opacity: 0, x: -16 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            <h3 className="text-sm font-bold text-white uppercase tracking-wider mb-5">{tt("research.patentsTitle")}</h3>
          ...
          <motion.div initial={{ opacity: 0, x: 16 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            <h3 className="text-sm font-bold text-white uppercase tracking-wider mb-5">{tt("research.papersTitle")}</h3>
