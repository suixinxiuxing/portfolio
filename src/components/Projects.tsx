...
export default function Projects() {
  ...
  const projects = [
    { title: tt("projects.p1Title"), sub: tt("projects.p1Sub"), role: tt("projects.p1Role"), period: "2021.10 — 2023.06", techs: ["STAR-CCM+", "CFD", lang==="zh"?"结构设计":"Structural Design"], details: [tt("projects.p1d1"), tt("projects.p1d2")], award: tt("projects.p1Award") },
    { title: tt("projects.p2Title"), sub: tt("projects.p2Sub"), role: tt("projects.p2Role"), period: "2022.03 — 2022.07", techs: ["Python", lang==="zh"?"信号处理":"Signal Processing", lang==="zh"?"声学分析":"Acoustics"], details: [tt("projects.p2d1"), tt("projects.p2d2")], award: tt("projects.p2Award") },
  ];
